        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('addImage')}}" data-toggle="validator" novalidate="true" enctype="multipart/form-data">
                          @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Image Name *</label>
                                        <input type="text" class="form-control" placeholder="Enter title image"
                                            data-errors="Please Enter Name." required="" name="fileName">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id_product" id="">
                                            @foreach ($products as $product)
                                                <option value="" hidden>Chose Product</option>
                                ...
                                <div class="col-md-12">
                                  <div class="form-group">
                                      <label>Image Navbar *</label>
                                      <input type="file" class="form-control image-file" name="imgNav">
                                  </div>
                              </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control image-file" name="imgDes">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Description"
                                            data-errors="Please Enter Name." required="" name="description">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>

                            </div>
                            <button type="submit" class="btn btn-primary mr-2 disabled">Add Image</button>
