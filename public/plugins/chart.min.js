...
!(function (t, e) {
    ...
    class Ri {
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return (
                g.$shared &&
                    ((g.$shared = l), (s[a] = Object.freeze(Li(g, l)))),
                g
            );
        }
            ...
            i &&
                ...
                J(s, (i) => {
                    const s = i.options,
                        ...
                        l = K(s.type, i.dtype);
                    (void 0 !== s.position &&
                        Un(s.position, r) === Un(i.dposition)) ||
    ...
    class Eo extends Ei {
        ...
        get segments() {
            return (
                this._segments ||
                (this._segments = Sn(this, this.options.segment))
            );
        }
        first() {
    ...
    var us = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < n; ++a)
                (l = o[a]),
                    l && !1 !== l.fill && (l.fill = os(o, a, i.propagate));
        },
        beforeDraw(t, e, i) {
    ...
    class Os extends Ei {
        ...
        getTitle(t, e) {
            ...
            let r = [];
            return (
                (r = _s(r, ys(o))), (r = _s(r, ys(s))), (r = _s(r, ys(a))), r
            );
        }
        getBeforeBody(t, e) {
            ...
            const o = (function (t, e) {
                ...
                for (
                    ...
                    (d && v !== s
                        ? (i.push({ value: s }),
                          v < s && P++,
                          At(Math.round((v + P * k) * y) / y, s, Es(s, _, t)) &&
                              P++)
                        : v < s && P++);
                    P < M;
                    ++P
            ...
            return (
                ...
                (t._majorUnit =
                    n.major.enabled && "year" !== t._unit
                        ? (function (t) {
                              for (
                                  let e = Xs.indexOf(t) + 1, i = Xs.length;
                                  e < i;
                                  ++e
                              )
